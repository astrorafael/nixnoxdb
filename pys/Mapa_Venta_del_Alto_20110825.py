...
# IBN FIRNAS (SEVILLA)  
# SQM:	SEA#03											
#LUGAR DE MEDICION:	Venta del Alto											
#LATITUD:	37	37	36	NORTE								
#LONGITUD:	6	8	6	OESTE								
#ALTITUD:	275 m											
#FECHA:	25/08/11											
...
#20	20,72	20,64	20,55	20,22	19,42	19,27	19,46	20,04	20,24	20,24	20,57	20,65
#40	20,84	20,76	20,72	20,59	20,16	20,12	20,21	20,43	20,52	20,70	20,82	20,84
#60	20,83	20,84	20,80	20,76	20,59	20,61	20,63	20,64	20,69	20,77	20,84	20,87
#80	20,85	20,83	20,83	20,80	20,77	20,79	20,80	20,78	20,78	20,79	20,80	20,82
#90	20,84											

#        S -> W -> N -> E -> S
m20 = [19.46,	20.04,	20.24,	20.24,	20.57,	20.65,  20.72,	20.64,	20.55,	20.22,	19.42,	19.27]	
m40 = [20.21,	20.43,	20.52,	20.70,	20.82,	20.84,  20.84,	20.76,	20.72,	20.59,	20.16,	20.12]	
m60 = [20.63,	20.64,	20.69,	20.77,	20.84,	20.87,  20.83,	20.84,	20.80,	20.76,	20.59,	20.61]	
m80 = [20.80,	20.78,	20.78,	20.79,	20.80,	20.82,  20.85,	20.83,	20.83,	20.80,	20.77,	20.79]	
m90 = [20.84]					
...
CS2=contour(CS,levels=[17.0,17.4,17.8,20.2,20.4,20.6,20.7,20.8,21.1,21.3,21.5], colors='w',origin='upper',hold='on')
