...
# LUGAR Talamanca 
# FECHA	2011/08/05
# Observadores: Carles Schnabel AA Sabadell

# Fotómetro SQM  	N. SERIE SQM: 
# 41.733 N
# 01.9821 E
# ALTITUD (m):	       550												

# HORA INICIO	00 TU aprox
# HORA FINAL	
...
# 90 cénit 20.69
#        S -> W -> N -> E -> S 
# Alt/Az 0      30     60     90     120    150    180    210    240    270    300    330    360 
# 75     21.14, 21.18, 21.21, 21.24, 21.25, 21.28, 21.24, 21.20, 21.16, 21.14, 21.11, 21.11, 21.13
# 60     21.01, 21.13, 21.23, 21.29, 21.33, 21.33, 21.28, 21.18, 21.09, 21.08, 21.07, 21.02, 21.01
# 45     20.92, 21.00, 21.14, 21.24, 21.28, 21.27, 21.21, 21.08, 21.03, 21.09, 21.06, 21.00, 20.94
# 20     20.85, 20.87, 20.88, 20.88, 21.06, 20.89, 20.74, 20.68, 20.63, 20.59, 20.38, 20.66, 20.86

#        S -> W -> N -> E -> S 
m90 = [21.25]
m75 = [21.14,21.18,21.21,21.24,21.25,21.28,21.24,21.20,21.16,21.14,21.11,21.11]
m60 = [21.01,21.13,21.23,21.29,21.33,21.33,21.28,21.18,21.09,21.08,21.07,21.02]
m45 = [20.93,21.00,21.14,21.24,21.28,21.27,21.21,21.08,21.03,21.09,21.06,21.00]
m20 = [20.85,20.87,20.88,20.88,21.06,20.89,20.74,20.68,20.63,20.59,20.38,20.66]
...
todom = m20 + m45 + m60 + m75 + m90
todox = x20 + x45 + x60 + x75 + x90
todoy = [20] * 14 + [45] * 14 + [60] * 14 + [75] * 14 + [90] * 14
...
ax.text(5.36,1.7, "2011-08-05", fontsize=14, horizontalalignment='center')
ax.text(4.1,1.7, "mag/arcsec$^2$", fontsize=14, horizontalalignment='center')
# ax.text(1.2,-1.7, "20-45-60-75-90", fontsize=16, horizontalalignment='left')
...
# 41.733 N
# 01.9821 E
# LATITUD:	41 43 58.8 N
# LONGITUD:	01 58 55.6 E
LAT= "41 43 58.8 N"				
LONG="01 58 55.6 E"			
...
#CS2=contour(CS,levels=[19.0,20.6,20.9,21.0,21.1,21.2,21.3], colors='w',origin='upper',hold='on')
CS2=contour(CS,levels=[17.0,17.4,17.8,19.6,20.9,21.0,21.1,21.2,21.3], colors='w',origin='upper',hold='on')
