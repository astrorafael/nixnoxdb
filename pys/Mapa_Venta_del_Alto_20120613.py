...
# Temperatura:	
# Humedad	
# Localización:	Venta del Alto
# Latitud:	37:37:30
# Longitud:	06:07:55
# Altitud:	275 m
	
# Medida en el cenit:	20.89
	
# S W N E	
	
m20 = [19.96, 19.47, 19.12, 19.48, 20.1, 20.18, 20.42, 20.53, 20.54, 20.62, 20.39, 20.22]	
m40 = [20.3, 20, 19.92, 20.04, 20.45, 20.56, 20.67, 20.7, 20.68, 20.67, 20.51, 20.39]	
m60 = [20.49, 20.49, 20.42, 20.57, 20.7, 20.76, 20.78, 20.83, 20.83, 20.75, 20.74, 20.65]	
m80 = [20.74, 20.72, 20.72, 20.76, 20.8, 20.81, 20.84, 20.86, 20.86, 20.82, 20.83, 20.75]	
m90 = [20.89]	

# S W N E	
	
m20 = [21.02, 20.78, 20.77, 20.94, 21.3, 20.98, 21, 21.04, 20.91, 20.97, 21.18, 21.06]	
m40 = [20.96, 20.97, 21.11, 21.21, 21.22, 21.18, 21.18, 21.02, 20.92, 21.02, 21.14, 21.09]	
m60 = [21.06, 21.11, 21.24, 21.31, 21.35, 21.33, 21.33, 21.18, 21.08, 21.1, 21.17, 21.15]	
m80 = [21.11, 21.12, 21.18, 21.22, 21.28, 21.32, 21.33, 21.31, 21.2, 21.17, 21.15, 21.11]	
m90 = [21.31]
...
label = u"Venta del Alto"
ax.text(1.6,1.5, label, fontsize=18, horizontalalignment='center')
ax.text(5.36,1.7, "2012-06-13", fontsize=14, horizontalalignment='center')
...
# Latitud:	37:37:30
# Longitud:	06:07:55
#LATITUD:	37	37	30	NORTE								
#LONGITUD:	06	07	55	OESTE								
LAT= "37 37 30 N"				
LONG="06 07 55 W"			
...
CS2=contour(CS,levels=[17.0,17.4,17.8,20.2,20.4,20.6,20.8,20.9,21.0,21.1,21.2,21.3,21.5], colors='w',origin='upper',hold='on')
