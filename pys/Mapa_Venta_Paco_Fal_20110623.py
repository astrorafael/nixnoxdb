...
# IBN FIRNAS (SEVILLA)  
# SQM:	SEA#03											
# LUGAR DE MEDICION:	Venta de Paco Fal											
# LATITUD:	37	46	56	NORTE								
# LONGITUD:	6	10	58	OESTE								
# ALTITUD:	370 m											
# FECHA:	23/06/11											
# HORA INICIAL:	00:50:00											
# HORA FINAL:	01:15:00											
# ESTADO DEL CIELO:	Despejado											
# TEMPERATURA:	18,5C											
# HUMEDAD:	41 por ciento											
												
#     180N  210NNE 240ENE	270E	300ESE 330SSE	0S	30SSW  60WSW  90W  120WNW   150NWN
#20	21,21	21,18	21,09	20,28	20,27	20,48	20,34	20,77	21,08	21,14	21,08	21,10
#40	21,50	21,34	21,16	21,06	20,41	20,95	20,93	21,20	21,29	21,28	21,28	21,29
#60	21,60	21,51	21,44	21,34	21,33	21,36	21,37	21,36	21,49	21,47	21,51	21,54
#80	21,61	21,51	21,51	21,48	21,41	21,47	21,46	21,49	21,50	21,50	21,52	21,54
#90	21,62																							
#        S -> W -> N -> E -> S
m20 = [20.34,	20.77,	21.08,	21.14,	21.08,	21.10,   21.21,	21.18,	21.09,	20.28,	20.27,	20.48]	
m40 = [20.93,	21.20,	21.29,	21.28,	21.28,	21.29,   21.50,	21.34,	21.16,	21.06,	20.41,	20.95]	
m60 = [21.37,	21.36,	21.49,	21.47,	21.51,	21.54,   21.60,	21.51,	21.44,	21.34,	21.33,	21.36]	
m80 = [21.46,	21.49,	21.50,	21.50,	21.52,	21.54,   21.61,	21.51,	21.51,	21.48,	21.41,	21.47]
m90 = [21.62]					
...
label = u"Venta de Paco Fal"
ax.text(1.6,1.5, label, fontsize=18, horizontalalignment='center')
ax.text(5.36,1.7, "2011-06-23", fontsize=14, horizontalalignment='center')
...
CS2=contour(CS,levels=[17.0,17.4,17.8,19.6,20.8,21.1,21.2,21.3,21.4,21.5], colors='w',origin='upper',hold='on')
