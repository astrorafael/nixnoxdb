...
# Temperatura:	18,8ºC
# Humedad	69%
# Localización:	Vega de Carmona (Arahal)
# LONGITUD: 	37 18 55 N
# LATITUD :	05 34 02 W
# ALTITUD:	120 m
# Medida en el cenit:	20.93
# Cerca de Arahal
	
# S W N E	
	
m20 = [19.86, 19.99, 19.97, 19.38, 19.34, 19.83, 20.29, 20.34, 20.33, 20.2, 20.07, 19.93]	
m40 = [20.28, 20.44, 20.45, 20.2, 20.27, 20.48, 20.55, 20.57, 20.52, 20.48, 20.44, 20.32]	
m60 = [20.64, 20.72, 20.76, 20.73, 20.73, 20.77, 20.89, 20.8, 20.72, 20.65, 20.63, 20.61]	
m80 = [20.82, 20.84, 20.92, 20.88, 20.9, 20.9, 20.96, 20.88, 20.84, 20.83, 20.86, 20.8]	
m90 = [20.93]	
...
label = u"Vega de Carmona (Arahal)"
ax.text(1.6,1.5, label, fontsize=18, horizontalalignment='center')
ax.text(5.36,1.7, "2014-06-29", fontsize=14, horizontalalignment='center')
...
CS2=contour(CS,levels=[19.9,20.1,20.3,20.5,20.7,20.9], colors='w',origin='upper',hold='on')
