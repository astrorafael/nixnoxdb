...
# ALTITUD:	699 m			
#               FECHA	     HORA (TU)	T 12 (C)    H (%)	cénit	cielo	 
# INICIO	10/11/2015     22h35m	  		21.21	despejado  	
# FINAL:	10/11/2015     23h35m	        	21.28	despejado							

# OBSERVACIONES:
# 1. Humedad algo significativa quizás debido a la hierba mojada del terreno.
# 2. Al Este se situa Villanueva de Córdoba y al Oeste Pozoblanco con focos  de contaminación lumínica relevante.
